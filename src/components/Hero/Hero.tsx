const Hero = () => {
    return (
      <div>
        <section className="flex flex-col w-full px-4 py-20 md:px-28 md:py-32 items-center justify-around md:flex-row gap-10 md:gap-10" id="hero">
          ...
          <div className="flex flex-col space-y-4 max-w-lg text-left md:text-left">
            <h1 className="text-4xl sm:text-5xl md:text-6xl leading-[1.8] sm:leading-[1.9] font-normal text-black">
              Hello I'm <span className="text-black font-bold">Evren Shah.</span>
              <br />
              <span className="text-black font-bold mt-4 mb-2 mr-2 text-3xl sm:text-6xl md:text-6xl lg:text-5xl xl:text-5xl">Frontend</span>
              <span className="text-white font-extrabold text-3xl text-shadow-lg text-stroke 
