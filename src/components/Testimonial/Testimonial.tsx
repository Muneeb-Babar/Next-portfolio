    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 px-0 justify-items-center">
      ...
      <div className="max-w-sm bg-white rounded-2xl border shadow-md shadow-gray-300">
        <div className="flex flex-col items-center justify-center p-10">
          <img src="/assets/clientimg1.png" alt="Everen Shah" loading="lazy" width="80" height="80" className="mb-3 rounded-full shadow-lg" />
          <p className="text-sm text-gray-900 text-center mb-10">Remarkable impact! Shahrukh transformed our digital presence at Patron. Their strategies were spot-on, driving notable growth. Highly recommended for exceptional digital marketing expertise.</p>
      ...
      <div className="max-w-sm bg-black rounded-2xl border shadow-md shadow-gray-300">
        <div className="flex flex-col items-center justify-center p-10">
          <img src="/assets/clientimg2.png" alt="Floora Sheen" loading="lazy" width="80" height="80" className="mb-3 rounded-full shadow-lg" />
          <p className="text-sm text-white text-center mb-10">Remarkable impact! Shahrukh transformed our digital presence at Patron. Their strategies were spot-on, driving notable growth. Highly recommended for exceptional digital marketing expertise.</p>
